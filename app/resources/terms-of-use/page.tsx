  ...
  return (
    <>
      ...
      <ul className="list-disc list-inside mt-2 ml-2">
        <li key="0">Generated and storing API access credentials</li>
        <li key="1">Accessing additional webstore information via the Neto API</li>
        <li key="2">Displaying and using that data within this application</li>
      </ul>

        <p className="mt-6">Any data entered is only stored for the length of the browser session and is not shared with any 3rd parties. If you do not agree with these terms no not enter any personal or identifiable information into this application. By navigating and/or visiting this application some usage data may be recorded.</p>
        </section>
    </>
  );
}
