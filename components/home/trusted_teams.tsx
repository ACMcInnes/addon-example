...
export default function TrustedTeams() {
  return (
    <div className="mt-20 w-full max-w-screen-xl">
      ...
      <p className="w-full max-w-screen-xl text-center mt-2 text-pretty text-3xl font-semibold tracking-tight text-gray-900 dark:text-gray-100 sm:text-4xl lg:text-balance">
