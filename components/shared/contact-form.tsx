...
export default function ContactForm() {
  ...
  return (
    <form className="flex flex-col mx-auto mt-6 w-full md:w-8/12 lg:w-5/12" onSubmit={handleSubmit}>
      <label className="mt-2 text-start" htmlFor="full-name">Full Name</label>
      ...
      <label className="mt-2 text-start" htmlFor="email">Email Address</label>
      ...
      <label className="mt-2 text-start" htmlFor="message">Message</label>
      ...
      <button type="submit" disabled={state.submitting} className="mt-2 py-2 px-4 rounded-md text-gray-100 bg-indigo-600 hover:bg-indigo-500 dark:bg-indigo-500 dark:hover:bg-indigo-400 border-transparent">
        Submit
      </button>
