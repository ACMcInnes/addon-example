...
export default async function User() {
  const session = await auth();
    ...
    return (
      <section className="z-10 static xl:sticky top-6 right-0 ml-auto w-72 flex flex-row gap-4 my-6 xl:my-0 py-2 px-4 rounded-full text-gray-100 bg-indigo-600 dark:bg-indigo-900 border-transparent">
